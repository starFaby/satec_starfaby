...
class ClientServiceParroquiaGeneral:
    ...
    def ongetClientServiceParroquiaGeneral(self):
        try:
            ...
            parroquiaGeneralList = Parroquia.query.join(Tipozona, Parroquia.pfssatectipozonaid == Tipozona.pfssatectipozonaid).join(Canton, Parroquia.pfssateccantonid == Canton.pfssateccantonid).add_entity(Parroquia.pfssatecparroquianombre).add_entity(Tipozona.pfssatectipozonanombre).add_entity(Canton.pfssateccantonnombre).filter(Parroquia.pfssatecparroquiaestado == 1)
