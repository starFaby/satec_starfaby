...
class ClientServiceCanton:
    ...
    def ongetClientServiceCanton(self):
        try:
            ...
            cantonList = Canton.query.join(Provincia, Canton.pfssatecprovinciaid == Provincia.pfssatecprovinciaid).join(Capital, Capital.pfssatecprovinciaid == Provincia.pfssatecprovinciaid).add_entity(Canton.pfssateccantonid).add_entity(Canton.pfssateccantonnombre).add_entity(Provincia.pfssatecprovincianombre).add_entity(Capital.pfssateccapitalnombre).order_by(Canton.pfssateccantonid.asc())
            return cantonList
